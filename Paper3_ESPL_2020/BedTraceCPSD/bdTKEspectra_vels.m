...
clear
close all
load('d:\Mekong_W2015\DataAnalysis\Paper3\BottomTrack\VTA1a_bdtrace.mat')
bd = vpro1.bdist;bdt = vpro1.time;clear vpro1 vpro2 vpro3
load('d:\Mekong_W2015\DataAnalysis\Paper3\VPs\13March2015a_Vels.mat')
...
set(p,'xlim',[-0.5 20])
linkaxes(p,'xy')
title('Autocorrelation after differencing, x-shore velocity')
xlabel('k (Lags)')
ylabel('r_k')
...
tilefigs
sdir = 'd:\Mekong_W2015\Figures\Paper3\BedCPSD\';
fname = 'VTA1a';
