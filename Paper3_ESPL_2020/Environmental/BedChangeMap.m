clear, close all
%plot bed map
figdir = 'd:\Projects\Documents\Writing\GM_2018_Norris\Figures\V4\';
f1 = figure(1);
set(f1,'PaperOrientation','portrait',...
    'renderer','painters',...
    'position',[400 100   450   900]);
dirc = 'f:\Mekong_W2015\Images\Quadrats\Q2\Reconstructions\';
qdat = 'f:\Mekong_W2015\Images\Quadrats\Q2\Reconstructions\2A\Analysis\';
...
roty = [0,0];
rotz = [0,0];
cc = brewermap(15,'RdYlBu');symb = {'o';'d';'p'};
...
export_fig([figdir 'BedChangeMap_v3'],'-pdf')