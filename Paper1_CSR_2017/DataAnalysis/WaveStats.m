...
clear %a good idea
close all
load('d:\Projects\Mekong_W2015\Data\Vector\SW_Mudflat\V5108_080315.mat')
name = 'V5108'; %instrument
dname = 'HTA_F2F3';
zp = 0.2; %pressure sensor height above bottom
zuv = 0.3; %height of velocity sensor above bottom
intv = 600; %averaging interval (seconds)
start = datenum(2015,03,08,00,00,00);
stop = datenum(2015,03,12,12,00,00);
savedatfile = 1;
