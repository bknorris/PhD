...
if exist([dir1 'Data_Fig1_v3.mat'],'file')
    UWaqd = {'AQD_SW_2015.mat';'AQD_NE_2015.mat'};
    WKaqd = {'AD5117_9March2015.mat';'AD5117_12March2015.mat'};
    WKadv = {'VC101_050315.mat';'VC101_100315.mat';'VC101_110315.mat'};
    UWrbr = {'RBR_SW_2015.mat';'RBR_NE_2015.mat'};
    WKrbr = 'RBR_15244.mat';
    UWhobo = 'SW_2015.mat';
    load('d:\Mekong_W2015\Data\Weather\Mekong2015_metstation.mat')
    data = struct();
    ...
    save('d:\Mekong_W2015\DataAnalysis\TOS\Data_Fig1_v3','data','-v7.3')
else
