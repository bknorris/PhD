%Figure out the current rotations for the FSS2 (2014) experiment

close all
clear

pw = 'D:\Projects\Mekong_F2014\Data\Aquadopp\FSS2\';
files = {'HR5116.mat';'HR5117.mat';'HR3.mat';'HR4.mat'};
names = {'5116';'5117';'HR3';'HR4';'VC101'};
symb = {'o';'^';'s';'d';'p';'h'};
scale = 0.01;
start = datenum(2014,09,28,15,15,00);
stop = datenum(2014,09,28,16,10,00);
count = 1;
...
clear aqdp
%Load the Vector
pw = 'D:\Projects\Mekong_F2014\Data\Vector\FSS2\';
files = {'VC101_280914.mat'};
...
xlabel('lon')
ylabel('lat')
title('Current Vectors, FSS2')
export_fig([savefigdir 'FSS2_allCurvec'],'-pdf','-nocrop')
figure(2)
set(gca,'YLim',[0 2])
xlabel('Time on 28/09/2014')
ylabel('dbar')
title('Pressure Records, FSS2 Multiple Instruments')
legend(pp,names)
export_fig([savefigdir 'FSS2_allPres'],'-pdf','-nocrop')
figure(3)
xlabel('lon')
ylabel('lat')
title('Progressive Vectors, FSS2 Multiple Instruments')
legend(pd,names,'location','southwest')
export_fig([savefigdir 'FSS2_allPVDs'],'-pdf','-nocrop')
