%Figure out the current rotations for the FSS (F2F) experiment

close all
clear

pw = 'D:\Projects\Mekong_F2014\Data\Aquadopp\F2F\';
files = {'HR5116.mat';'HR5117.mat';'HR3.mat';'HR4.mat'};
names = {'5116';'5117';'HR3';'HR4';'VC101'};
symb = {'o';'^';'s';'d';'p';'h'};
scale = 0.01;
start = datenum(2014,09,29,16,48,00);
stop = datenum(2014,09,30,08,00,00);
count = 1;
...
clear aqdp
%Load the Vector
pw = 'D:\Projects\Mekong_F2014\Data\Vector\F2F\';
files = {'VC101_290914.mat'};
...
xlabel('lon')
ylabel('lat')
title('Current Vectors, F2F-1')
export_fig([savefigdir 'F2F_allCurvec'],'-pdf','-nocrop')
figure(2)
set(gca,'YLim',[0 2])
xlabel('Time on 29/09/2014')
ylabel('dbar')
title('Pressure Records, F2F-1 Multiple Instruments')
legend(pp,names)
export_fig([savefigdir 'F2F_allPres'],'-pdf','-nocrop')
figure(3)
xlabel('lon')
ylabel('lat')
title('Progressive Vectors, F2F-1 Multiple Instruments')
legend(pd,names,'location','southeast')
export_fig([savefigdir 'F2F_allPVDs'],'-pdf','-nocrop')
