...
load('d:\Projects\Mekong_W2015\DataAnalysis\Paper2\AveragedVelocities\Two\U_z_gradient_v5.mat')
s = [9 9 9;6 6 6;3 3 3];
for i = 1:3
    fn = fieldnames(RS.(dn{i}));
    for j = 1:3
        ...
        grid on
        if i == 2
            plot(linspace(-5E-4,5E-3,10),ones(10,1)*0.33,'--k','linewidth',1.5)
        end
    end
end
...
set(sp(1),'xlim',[0.02 0.03],'xtick',0.02:0.005:0.03)
%RS
set([sp(2) sp(5) sp(8)],'xlim',[-10E-3 10E-3],'xtick',-10E-3:10E-3:10E-3)
%EV
set([sp(3) sp(6) sp(9)],'xlim',[-2.5E-4 2.5E-3],'xtick',0:1E-3:2.5E-3)
%row 3
...
export_fig([savefigdir 'TurbStats_HTA_v2'],'-pdf')