...
%for the VTA experiment (2 x 3 panel subplots). This is version 2 of this
%script.
clear, close all
...
set([sp(1) sp(3) sp(5)],'xlim',[-1E-2 1E-2],'xtick',-1E-2:1E-2:1E-2)
set([sp(2) sp(4) sp(6)],'xlim',[-1E-3 2E-3],'xtick',-1E-3:1E-3:2E-3)
%HTA
...
export_fig([savefigdir 'TurbStats_VTA_v2'],'-pdf')